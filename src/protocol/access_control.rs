...
use iroh_docs::{DocTicket, Entry, api::Doc, store::Query};
...
impl AccessControl {
    ...
    async fn handle_request(
        ...
        let Some((_, access_list)) = self.list_manager.get_access_list(&request.resource).await?
        else {
...
impl Request {
    pub fn new(resource: String, filename: String) -> Self {
