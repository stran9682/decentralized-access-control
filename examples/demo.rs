...
use iroh::{Endpoint, endpoint::presets::{self}, protocol::Router};
...
async fn main() -> anyhow::Result<()> {
    ...
    let access_control = AccessControl::new(list_manager.clone());
    ...
    list_manager.append_access_list("tag", &endpoint.id()).await?;
